...
class HomeViewModel extends ChangeNotifier {
  final List<CalendarEvent> _events = [
    ...
    //   AppColors.red,
    // ),
    // CalendarEvent(7, 'Networking con Startups', DateTime(2024, 10, 18, 16, 0),
    //     'Surquillo', AppColors.pink,
    //     isFavorite: true),
    // CalendarEvent(
    //   8,
    //   'Seminario de IA',
    //   DateTime(2024, 10, 19, 9, 30),
    //   'Pueblo Libre',
    //   AppColors.blue,
    //   isFavorite: true,
    //   isPublic: true,
    ...
    //   DateTime(2024, 10, 20, 10, 0),
    //   'La Molina',
    //   AppColors.yellow,
    //   isPublic: true,
    // ),
    // CalendarEvent(10, 'Reunión de Evaluación', DateTime(2024, 10, 21, 13, 0),
    //     'Magdalena', AppColors.red,
    //     isPublic: true),
    // CalendarEvent(
    //   11,
    //   'Cena de Gala',
    //   DateTime(2024, 10, 22, 18, 0),
    //   'San Miguel',
    //   AppColors.pink,
    //   isPublic: true,
    // ),
